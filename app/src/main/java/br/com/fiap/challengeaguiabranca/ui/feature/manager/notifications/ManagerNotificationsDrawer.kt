package br.com.fiap.challengeaguiabranca.ui.feature.manager.notifications
...
@Composable
fun ManagerNotificationsDrawerSheet(
            ...
            if (notifications.isEmpty()) {
                ...
                LazyColumn(
                    ...
                    items(notifications, key = { it.id }) { notification ->
                        ManagerNotificationCard(notification)
                    }
...
@Composable
private fun ManagerNotificationCard(notification: ManagerNotification) {
    Card(
